use ast::functions::{FunctionBody, FunctionDeclaration, FunctionImplementation};
use nom::{
    IResult, Parser, branch::alt, bytes::complete::tag, character::complete::multispace1,
    combinator::map, multi::separated_list1, sequence::terminated,
};
